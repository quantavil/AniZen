...
class GoogleDriveSyncService(context: Context, json: Json, syncPreferences: SyncPreferences) : SyncService(
    ...
    private val remoteFileName = "AniZen_sync.proto.gz"
...
class GoogleDriveService(private val context: Context) {
    ...
    companion object {
        const val REDIRECT_URI = "com.googleusercontent.apps.1036904236703-8f782r03uqs8hnf7q7udk69fe6lki3j2:/oauth2redirect"
    }
